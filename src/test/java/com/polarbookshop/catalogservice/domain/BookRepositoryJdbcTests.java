...
public class BookRepositoryJdbcTests {
    ...
    public void findBookByIsbnWhenExisting(){
        ...
        Book book = Book.of(bookIsbn, "Title", "Author", 12.90, "Unisys");
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", 12.90, "Unisys");
        var book2 = Book.of("1234561236", "Another Title", "Author", 12.90, "Unisys");
    ...
    void existsByIsbnWhenExisting() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 12.90, "Unisys");
